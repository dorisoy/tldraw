import { HistoryEntry, MigrationOptions, SerializedStore, Store, StoreSchema } from '@tldraw/store'
import {
	SchemaShapeInfo,
	TLRecord,
	TLStore,
...
export type TLStoreOptions = {
	...
	| { shapeUtils?: readonly TLAnyShapeUtilConstructor[], migrations?: MigrationOptions }
